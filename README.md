...
For more info, see [Poster](<docs/report/Integrating a new model into the Unitraj framework Multimodal Motion Prediction with Stacked Transformers (mmTransformer)-1.pdf>) and [Report](docs/report/CIVIL_459_Milestone3-1.pdf)
